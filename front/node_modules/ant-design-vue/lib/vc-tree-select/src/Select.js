  ...
  methods: {
    getDerivedStateFromProps: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      if (newState._searchValue !== undefined || prevState._searchValue && treeNodes) {
        ...
        newState._filteredTreeNodes = (0, _util.getFilterTree)(this.$createElement, newState._treeNodes || prevState._treeNodes, searchValue, filterTreeNodeFn, newState._valueEntities || prevState._valueEntities);
      }
    ...
    onTreeNodeCheck: function onTreeNodeCheck(_, nodeEventInfo) {
      ...
      if (searchValue) {
        ...
        if (isAdd) {
          ...
          keyList = (0, _util.conductCheck)([(0, _propsUtil.getPropsData)(nodeEventInfo.node).eventKey], false, keyEntities, { checkedKeys: oriKeyList }).checkedKeys;
        }
    ...
    onSearchInputChange: function onSearchInputChange(_ref15) {
      ...
      if (isSet) {
        ...
        this.setState({
          _filteredTreeNodes: (0, _util.getFilterTree)(this.$createElement, treeNodes, value, filterTreeNodeFn, valueEntities)
        });
      }
    },
    ...
    */
    ...
    delayForcePopupAlign: function delayForcePopupAlign() {
      ...
      (0, _raf2['default'])(function () {
        (0, _raf2['default'])(_this3.forcePopupAlign);
      });
    },
