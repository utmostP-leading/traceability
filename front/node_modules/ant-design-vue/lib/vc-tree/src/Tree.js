...
var Tree = {
  ...
  data: function data() {
    ...
    return (0, _extends3['default'])({}, state, this.getDerivedStateFromProps((0, _propsUtil.getOptionProps)(this), state));
  },
  ...
  watch: (0, _extends3['default'])({}, getWatch(['treeData', 'children', 'expandedKeys', 'autoExpandParent', 'selectedKeys', 'checkedKeys', 'loadedKeys']), {
    __propsSymbol__: function __propsSymbol__() {
      this.setState(this.getDerivedStateFromProps((0, _propsUtil.getOptionProps)(this), this.$data));
      this.needSyncKeys = {};
    }
  }),
  ...
  methods: {
    ...
    onNodeDragStart: function onNodeDragStart(event, node) {
      ...
      this.setState({
        _dragNodesKeys: (0, _util.getDragNodesKeys)(children, node),
      ...
      return new Promise(function (resolve) {
        ...
        _this2.setState(function (_ref) {
          ...
          promise.then(function () {
            var newLoadedKeys = (0, _util.arrAdd)(_this2.$data._loadedKeys, eventKey);
            var newLoadingKeys = (0, _util.arrDel)(_this2.$data._loadingKeys, eventKey);
